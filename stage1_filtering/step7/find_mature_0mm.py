...
novel_file_name = out_file_name + "_1_4mm" 
        ...
        if (len(rec.alignments)==0):
            ...
            for a in rec.alignments:
                ...
                for x in a.hsps:
                    ...
                    if (match_length >= 18 and ((query_length == match_length) or (subject_length == match_length)) and counter == 0 and mismatches_in_hsp == 0):
                        print "\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
                        print "hsps: "
                        print str(x)
                        ...
                        current_mature_dict = group_mature_dict[mirna]
                        current_mature_dict = current_mature_dict + rec.query + ','
